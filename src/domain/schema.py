...
from sqlalchemy import (BigInteger, Boolean, Column, Date, DateTime, ForeignKey,
                        Index, Integer, MetaData, Numeric, SmallInteger, String,
...
result = Table(
    ...
    Column("id_cpt", BigInteger,
           ForeignKey("competition.id_cpt", ondelete="CASCADE"), nullable=False),
    ...
    Index("uq_result_idres", "id_res", unique=True,
